...
public interface IGroupService
{
    ...
    Task<List<GroupRepayments>> GetGroupBalance(Guid groupId, CancellationToken ct = default);

    List<GroupRepayments> GetBalance(GroupEntity group, CancellationToken ct=default);
