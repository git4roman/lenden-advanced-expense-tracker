...
public interface IGroupService
{
    ...
    Task<List<TransactionResponseDto>> GetGroupBalance(Guid groupId, CancellationToken ct = default);

    List<TransactionResponseDto> GetBalance(GroupEntity group, CancellationToken ct=default);
